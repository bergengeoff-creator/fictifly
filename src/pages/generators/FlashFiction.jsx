...
const GENRE_COLORS = [
  ...
  { dark: '#6B7341', main: '#9BA87B', light: '#DCDCC8', pale: '#F0F0E8' }, // Crime Caper - Muted Olive
  ...
  { dark: '#4A5F73', main: '#7B96A8', light: '#D4E0E8', pale: '#F0F4F8' }, // Fantasy - Blue-Gray
  { dark: '#4A6B6B', main: '#7B9898', light: '#D4E0E0', pale: '#F0F4F4' }, // Ghost Story - Deep Teal
  { dark: '#6B7341', main: '#9BA87B', light: '#DCDCC8', pale: '#F0F0E8' }, // Historical Fiction - Muted Olive
  { dark: '#4A5F73', main: '#7B96A8', light: '#D4E0E8', pale: '#F0F4F8' }, // Horror - Blue-Gray
  { dark: '#4A6B6B', main: '#7B9898', light: '#D4E0E0', pale: '#F0F4F4' }, // Mystery - Deep Teal
  { dark: '#8B7341', main: '#C4A87A', light: '#E8D9C8', pale: '#F5F0E8' }, // Political Satire - Warm Gold
  ...
  { dark: '#A65C2A', main: '#D4845A', light: '#E8CCB5', pale: '#F5EAE0' }, // Spy - Rust Orange
  { dark: '#4A6B6B', main: '#7B9898', light: '#D4E0E0', pale: '#F0F4F4' }, // Suspense - Deep Teal
  { dark: '#4A6B6B', main: '#7B9898', light: '#D4E0E0', pale: '#F0F4F4' }, // Thriller - Deep Teal
  { dark: '#6B5D4E', main: '#D4845A', light: '#EDE3D4', pale: '#F5EAE0' }, // Open Genre - Taupe
];

const genreColor = (genre) => {
  const colors = GENRE_COLORS[GENRES.indexOf(genre) % GENRE_COLORS.length] || GENRE_COLORS[17];
